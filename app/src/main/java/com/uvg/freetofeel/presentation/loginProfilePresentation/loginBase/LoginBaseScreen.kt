...
@Composable
fun LoginBaseScreen(context: Context,
                    languageViewModel: LanguageViewModel,
                    onLoginClick: () -> Unit,
                    onNewAccClick: () -> Unit
) {
...
fun PreviewLoginBaseScreenDark() {
    ...
    MaterialTheme(
        ...
        LoginBaseScreen(context = context, languageViewModel = languageViewModel, onLoginClick = {}, onNewAccClick = {})
    }
}
